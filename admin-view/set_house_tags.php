...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($data['house_id'], $data['tag_id'])) {
        ...
        if ($conn->query($query) === TRUE) {
            echo json_encode([
                'success' => true, 
                'message' => 'Tag successfully added to house'
            ]);
        } else {
